...
<div class="content">
    ...
    <table>
        ...
        <tbody>
            @foreach($p as $convidados)
            <tr>
                <td>{{$convidados->nome}}</td>
                <td>{{$convidados->sobrenome}}</td>
                <td>{{$convidados->idade}}</td>
                @if($convidados->presenca == 1)
                    <td>Presente <a href="/ausente/{{$convidados->id}}/{{$convidados->reserva}}" type="button" class="btn btn-danger" title="Ausente" style="height: 5%; width: 10%;"><i class="bi bi-x"></i></a></td>
                @else
                    <td>Ausente <a href="/presente/{{$convidados->id}}/{{$convidados->reserva}}" type="button" class="btn btn-primary" title="Presente" style="height: 5%; width: 10%;"><i class="bi bi-check2"></i></a></td> 
                @endif
            </tr>
            @endforeach
        </tbody>
